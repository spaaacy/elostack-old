...
const JobApplicants = () => {
  ...
  // Mock data
  const applicants = [
    { id: 1, name: "John Doe", applied_at: new Date(), position: "intern", grade: "A", profile_picture_url: "url_to_picture" },
    { id: 2, name: "Jane Doe", applied_at: new Date(), position: "senior", grade: "B", profile_picture_url: "url_to_picture" },
...
<main className="container mx-auto p-4 bg-white rounded-lg shadow mt-8">
  ...
  <section data-aos="fade-right" className="bg-center p-8 rounded-lg shadow-lg">
    <div className="flex justify-between items-center -mt-[2rem] ">
      <h2 className="text-3xl font-bold text-blueprimary">Applicants</h2>
    </div>
