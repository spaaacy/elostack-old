...
const AccountPage = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // Here you'd handle form submission, such as sending data to your backend
  };
      ...
      <div className="bg-white shadow rounded-lg p-6 w-full lg:w-3/4 xl:w-1/2 mx-auto">
        <div className="max-w-4xl mx-auto p-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-xl font-semibold mb-6">Website</div>
            <div className="mb-4">
              <label
                htmlFor="portfolio"
                className="block text-sm font-medium text-gray-700"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="mt-1 mb-8 block w-full rounded border border-gray-300 bg-white px-5 py-2 shadow-sm placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              />
            </div>
