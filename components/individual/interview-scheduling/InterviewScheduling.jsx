...
const InterviewScheduling = () => {
  ...
  const resources = [
    ...
    },
    {
      ...
      description: "Improve communication, teamwork, and problem-solving skills critical for succeeding in interviews.",
    },
    {
      ...
      <div className="min-h-screen bg-gray-100 p-8">
        <div className="container mx-auto max-w-6xl bg-white rounded-lg shadow p-6 space-y-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Schedule Your Interview</h2>
            <CustomCalendar />
          </section>

          {/* Preparation Resources and Guidelines */}
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Preparation Resources</h2>
