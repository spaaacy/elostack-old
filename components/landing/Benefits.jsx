  ...
  const steps = [
    {
      ...
      image: "/laptop.png", // Add your placeholder image path here
    },
    {
      ...
      image: "/devices.png", // Add your placeholder image path here
    },
    {
      ...
      image: "/rocket.png", // Add your placeholder image path here
    },
  ];
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap">
          {steps.map((step, index) => (
            <div
              className="w-full mb-8 flex flex-col md:flex-row md:justify-center items-center md:items-stretch text-center md:text-left"
              key={index}
            ...
            >
              ...
              />
              <div
                className={`w-full md:w-1/2 p-8 flex flex-col justify-center items-center md:items-start ${
