    ...
    <>
      ...
      <main css={containerStyle}>
        <h1 className="text-white text-5xl md:text-8xl mb-5">
          ...
          Streamline Your Hiring Process <br />
          <span css={gradientTextStyle}>with EloStack</span>
        </h1>
        <h2 className="text-white text-xl md:text-2xl mb-10">
          Discover top software engineering talent. <br />
          Leverage mock interviews to make informed hiring decisions.
        </h2>
        <Link href={"/dashboard"}>
          <button css={buttonStyle}>Start Hiring with EloStack</button>
        </Link>
      </main>
    </>
  );
